...
const NOT_READY = "Meta Messenger inbound is scaffolded only. Add webhook route + Graph payload mapping.";

/**
 * Placeholder adapter — implement {@link InboundChannelAdapter} methods when the webhook ships.
 */
export const metaMessengerInboundAdapter: InboundChannelAdapter<unknown> = {
  channelKey: "meta_messenger",
